...
<table style="margin: 0; padding: 0; box-sizing: border-box; font-size: 14px; background-color: #f6f6f6; width: 100%;" width="100%" bgcolor="#f6f6f6">
	<tr style="margin: 0; padding: 0;">
		<td style="margin: 0; padding: 0; box-sizing: border-box; font-size: 14px; vertical-align: top;" valign="top"></td>
		<td style="padding: 0; vertical-align: top; display: block; max-width: 600px; margin: 0 auto; clear: both;" valign="top">
			<div style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; margin: 0 auto; display: block; padding: 20px;">
				<table width="100%" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0; background: #fff; border: 1px solid #e9e9e9; border-radius: 3px;">
					<tr style="margin: 0; padding: 0;">
						<td style="margin: 0; vertical-align: top; padding: 20px;" valign="top">
                    ...
                    Click the button below to login to your PayMate account.
								...
								<tr style="margin: 0; padding: 0;">
									<td style="margin: 0; box-sizing: border-box; font-size: 14px; vertical-align: top; padding: 0 0 20px;" valign="top">
				...
				<div style="margin: 0; box-sizing: border-box; font-size: 14px; width: 100%; clear: both; color: #999; padding: 20px;">
					<table width="100%" style="margin: 0; padding: 0; box-sizing: border-box; font-size: 14px;">
						<tr style="margin: 0; padding: 0;">
